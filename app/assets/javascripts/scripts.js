...
$(document).ready(function() {
    ...
    /*	DRIBBBLE
    /*-----------------------------------------------------------------------------------*/
    if ($(".owl-dribbble").length) {
        // NOTE: Don't use this token, replace it with your own client access token.
        jribbble.shots({token: "a78e71084428335514da5e9880089715c8890217e0a65cd44e2e3512d18363d7", per_page: 15}, function(shots) {
            document.querySelector(".shots.thumbs").innerHTML = shots.reduce(function(html, shot) {
                return html + '<div class="item"><figure><img src="' + shot.images.normal + '" alt="" /><a href="' + shot.html_url + '" class="link-out" target="_blank"><i class="icon-link"></i></a></figure></div>';
            }, "");
